(()=>{
  ...
  if(window.__MANGAMORPH_READER_LAYOUT_V5__)return;
  window.__MANGAMORPH_READER_LAYOUT_V5__=true;

  function installLayoutStyles(){
    if(document.querySelector("#readerLayoutFixV5"))return;
    const style=document.createElement("style");
    style.id="readerLayoutFixV5";
    style.textContent=`
      ...
      body.reader-body .reader-bottom-bar{display:grid!important;grid-template-columns:2.5rem minmax(8rem,11rem) 2.5rem 2.5rem!important;grid-template-rows:2.5rem!important;grid-auto-flow:column!important;align-items:center!important;justify-items:center!important;gap:.4rem!important;width:max-content!important;max-width:calc(100vw - 1.2rem)!important;min-height:0!important;height:auto!important;padding:.38rem!important;box-sizing:border-box!important;overflow:visible!important}
      ...
      body.reader-body .reader-bottom-bar #chapterPickerButton{grid-column:2!important;width:100%!important;min-width:0!important;max-width:none!important;white-space:nowrap!important}
      ...
      @media(max-width:560px){
        body.reader-body .reader-header{grid-template-columns:2.45rem minmax(0,1fr) 2.45rem!important;min-height:3.7rem!important;padding:.42rem .6rem!important;gap:.5rem!important}
        body.reader-body .reader-back,body.reader-body .reader-icon-button{width:2.45rem!important;height:2.45rem!important;min-width:2.45rem!important;border-radius:.74rem!important}
        ...
        body.reader-body .reader-bottom-bar{grid-template-columns:2.3rem minmax(7rem,8.8rem) 2.3rem 2.3rem!important;grid-template-rows:2.3rem!important;gap:.28rem!important;padding:.32rem!important;max-width:calc(100vw - .8rem)!important}
        body.reader-body .reader-bottom-bar>button:not(.reader-chapter-pill){width:2.3rem!important;height:2.3rem!important}
        body.reader-body .reader-bottom-bar .reader-chapter-pill{min-height:2.3rem!important;height:2.3rem!important}
      }
      @media(max-width:390px){
        body.reader-body .reader-bottom-bar{grid-template-columns:2.15rem minmax(6.6rem,8rem) 2.15rem 2.15rem!important;grid-template-rows:2.15rem!important;gap:.22rem!important}
        body.reader-body .reader-bottom-bar>button:not(.reader-chapter-pill){width:2.15rem!important;height:2.15rem!important}
        body.reader-body .reader-bottom-bar .reader-chapter-pill{min-height:2.15rem!important;height:2.15rem!important}
      }
    `;
  ...
  function loadCinematicHero(){
    ...
    script.src="assets/js/reader-hero.js?v=003";
    script.defer=true;
