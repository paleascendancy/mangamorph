const CACHE = "mangamorph-v0.17.20";
const ASSETS = [
  "./",
  "./index.html",
  "./manga.html",
  ...
  "./assets/js/catalog-cover-fix.js?v=001",
...
async function fetchFresh(request) {
  ...
  if (response.ok && destination === "script" && new URL(request.url).pathname.endsWith("/assets/js/catalog-runtime.js")) {
    ...
    const injected = source + '\nimport("./catalog-cover-fix.js?v=001").catch(error=>console.error("MangaMorph cover fix:",error));\n';
